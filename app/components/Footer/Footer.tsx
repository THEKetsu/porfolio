    ...
    <footer className={styles.footer}>
      <div className={styles.content}>
        <div className={styles.socialLinks}>
          <a href="https://www.linkedin.com/in/quentin-bender-8252241b8" target="_blank" rel="noopener noreferrer" className={`${styles.socialLink} ${styles.linkedin}`}>
          ...
          <a href="mailto:bender.quent@outlook.fr" className={`${styles.socialLink} ${styles.email}`}>
            <div className={styles.iconWrapper}>
              <svg className={styles.icon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 13.065l-11.985-8.065h23.97l-11.985 8.065zm-12-7.065v14h24v-14l-12 8.085-12-8.085z"/>
              </svg>
            </div>
            Email
          </a>
          <a href="https://github.com/THEKetsu" target="_blank" rel="noopener noreferrer" className={`${styles.socialLink} ${styles.github}`}>
            <div className={styles.iconWrapper}>
              <svg className={styles.icon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
