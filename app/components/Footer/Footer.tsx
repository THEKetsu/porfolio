      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.socialLinks}>
            <a
              href="mailto:bender.quent@outlook.fr"
            ...
            <a
              href="https://www.linkedin.com/in/quentin-bender-8252241b8"
              target="_blank"
            ...
            <a
              href="https://github.com/quentinbender"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="GitHub"
          ...
          <p className={styles.copyright}>
            © {currentYear} Quentin BENDER · DevSecOps Engineer
          </p>
